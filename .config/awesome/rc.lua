...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "web", "coding", "media", "misc", 5, 6, 7, 8, 9 }, s, layouts[1])
end
-- }}}
...
function get_extip()
	local fd = io.popen("~/extip.sh")
	local str = fd:read("*all")
	return str
end

extipwidget = widget({ type="textbox" })
...
extipwidget.text = " EXT IP: " .. get_extip() 
